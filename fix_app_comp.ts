...
import { Component, ChangeDetectionStrategy, HostListener, AfterViewInit, Inject } from '@angular/core';
...
export class AppComponent implements AfterViewInit {
  ...
  onWindowScroll() {
    ...
    if (scrollPosition > this.offsets['ABOUT'] && scrollPosition < this.offsets['EXPERIENCE']) {
      this.currentSection = 'ABOUT';
    } else if (scrollPosition >= this.offsets['EXPERIENCE'] && scrollPosition < this.offsets['PROJECTS']) {
