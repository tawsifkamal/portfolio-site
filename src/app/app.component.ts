...
export class AppComponent implements AfterViewInit {
  ...
  followerDisplay = signal('block');
  followerBackground = signal('');
  ...
  onMouseMove(e: MouseEvent) {
    ...
    this.followerBackground.set(`radial-gradient(600px at ${e.clientX}px ${e.clientY}px, rgba(29, 78, 216, 0.15), transparent 80%)`);
  }
