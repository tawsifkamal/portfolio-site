...
import { Component, HostListener, AfterViewInit, Inject, PLATFORM_ID, NgZone, OnDestroy, Renderer2 } from '@angular/core';
...
export class AppComponent implements AfterViewInit, OnDestroy {
  ...
  private mouseMoveCleanup: (() => void) | undefined;
    ...
    if (isPlatformBrowser(this.platformId)) {
      ...
      if (follower) {
        ...
        this.ngZone.runOutsideAngular(() => {
          this.mouseMoveCleanup = this.renderer.listen(
            this.document,
            'mousemove',
            (e: MouseEvent) => {
  ...
  get articles(): Article[] {
    return this.portfolio.articles();
  }
