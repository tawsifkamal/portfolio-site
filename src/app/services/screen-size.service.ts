...
export class ScreenSizeService {
  ...
  private isSmallSignal = computed(() => this.breakpointState().breakpoints[this.SMALL_SCREEN] ?? this.breakpointObserver.isMatched(this.SMALL_SCREEN));
  private isMediumSignal = computed(() => this.breakpointState().breakpoints[this.MEDIUM_SCREEN] ?? this.breakpointObserver.isMatched(this.MEDIUM_SCREEN));
  private isLargeSignal = computed(() => this.breakpointState().breakpoints[this.LARGE_SCREEN] ?? this.breakpointObserver.isMatched(this.LARGE_SCREEN));
