...
export class ScreenSizeService {
  ...
  get isSmall(): boolean {
    return this.breakpointState().breakpoints[this.SMALL_SCREEN] ?? false;
  }

  get isMedium(): boolean {
    return this.breakpointState().breakpoints[this.MEDIUM_SCREEN] ?? false;
  }

  get isLarge(): boolean {
    return this.breakpointState().breakpoints[this.LARGE_SCREEN] ?? false;
  }
}
